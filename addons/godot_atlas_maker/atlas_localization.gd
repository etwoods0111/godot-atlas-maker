...
const STRINGS := {
	LOCALE_ZH: {
		...
		"label_export_hint": "导出时输入图集名称；PNG、.tres、.res 和 JSON 都会保存到同名文件夹内。",
		"dialog_atlas_name_title": "输入图集名称",
		"dialog_atlas_name_ok": "下一步",
		"dialog_cancel": "取消",
		"dialog_atlas_name_label": "该名称会用于导出文件夹、PNG 文件、.res 文件和 JSON 映射文件。",
	...
	LOCALE_EN: {
		...
		"label_export_hint": "Enter the atlas name during export. PNG, .tres, .res, and JSON files will all be saved inside the same-named folder.",
		"dialog_atlas_name_title": "Enter Atlas Name",
		"dialog_atlas_name_ok": "Next",
		"dialog_cancel": "Cancel",
		"dialog_atlas_name_label": "This name is used for the export folder, PNG file, .res file, and JSON mapping file.",
