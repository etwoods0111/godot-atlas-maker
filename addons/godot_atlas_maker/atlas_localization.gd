...
const STRINGS := {
	LOCALE_ZH: {
		...
		"dialog_cancel": "取消",
		"dialog_atlas_name_label": "图集名称用于 PNG、.res 与 JSON 映射文件。",
		"dialog_atlas_name_placeholder": "例如 male_default_idle",
		"dialog_atlas_folder_label": "目标资源文件夹用于保存 PNG、.tres、.res 和 JSON。",
	...
	LOCALE_EN: {
		...
		"dialog_atlas_name_label": "The atlas name is used for the PNG, .res, and JSON mapping files.",
		"dialog_atlas_name_placeholder": "For example: male_default_idle",
		"dialog_atlas_folder_label": "The target resource folder stores PNG, .tres, .res, and JSON files.",
